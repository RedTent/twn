...
![](https://github.com/RedTent/twn/raw/master/inst/extdata/twn_hex.png)
...
#> $ refername  <chr> NA, NA, NA, NA, "Abies procera", NA, NA, NA, "Abies veitchi…
...
[`vignette("krw_beoordeling")`](https://redtent.github.io/twn/articles/krw_beoordeling.md).
